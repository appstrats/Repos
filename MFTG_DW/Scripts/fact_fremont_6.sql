...
T_SKU as
(select  step_index, serial_number, data_value SKU from MFGTESTC_FREMONT.dbo.process_step_data sd
...
T_ROMv as
(select  step_index, serial_number,data_value RV from MFGTESTC_FREMONT.dbo.process_step_data sd
where data_attribute like 'ROMVersion'and (sd.datestamp between @startdate and @enddate)),
T_SMV as
(select  step_index, serial_number, data_value SMV from MFGTESTC_FREMONT.dbo.process_step_data sd
