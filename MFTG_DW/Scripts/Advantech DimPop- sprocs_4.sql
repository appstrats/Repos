...
--exec sp_pop_RFID_advantech 7
create PROC sp_pop_RFID_advantech (@pLoadID int) as
begin
set nocount on
declare @startdate  datetime
declare @enddate  datetime
...
begin
with T_RFID as
(select distinct  data_value RFID from SHOPFLOOR_ADVANTECH.dbo.process_step_data sd
