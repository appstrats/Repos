...
or snta.Mac_Id like 'C0EAE4%' or snta.Mac_Id like '18B159%' or snta.Mac_Id like '004010%')  and (snta.Out_Process_Time between @startdate and @enddate ) 
...
select distinct Serial_Number, last_value(Mac_Id) over (partition by Serial_Number order by snta.Out_Process_Time asc) Mac_Id into #T_ASS from MES2_SERCOMM.dbo.sn_travel_assembly snta
 ...
 (snta.Mac_Id like '0005B1%' or snta.Mac_Id like '0017C5%' or  snta.Mac_Id like 'FFFFFF%'
or snta.Mac_Id like 'C0EAE4%' or snta.Mac_Id like '18B159%' or snta.Mac_Id like '004010%') and snta.Mac_Id <> 'N/A';

 with psr as
(select format(datastamp,'yyyyMMdd') datastampf, step_index, datastamp, station_type_code, Station_id, Serial_Number
